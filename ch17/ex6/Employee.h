...
protected:
    ...
    virtual std::ofstream & wData(std::ofstream & os) const = 0;
    virtual void Get() = 0;
private:
    string fname;
    string lname;
...
protected:
    ...
    virtual std::ofstream & wData(std::ofstream & os) const;
    virtual void Get() {};
public:
    Employee()
	:abstr_emp() {}
...
protected:
    ...
    void Data() const;
    std::ofstream & wData(std::ofstream & os) const;
    void Get();
public:
    Manager()
